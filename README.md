...
[<img alt="GitHub tag (with filter)" src="https://img.shields.io/github/v/tag/bendoerr-terraform-modules/terraform-aws-lambda?filter=v*&label=latest%20tag&logo=terraform">](https://github.com/bendoerr-terraform-modules/terraform-aws-lambda/tags)
